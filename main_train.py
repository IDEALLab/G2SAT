...
dataset_train = Dataset_sat(
    graphs_train, nodes_par1s_train, nodes_par2s_train, epoch_len=5000, yield_prob=args.yield_prob, speedup=True)
dataset_test = Dataset_sat(
    graphs_train, nodes_par1s_train, nodes_par2s_train, epoch_len=1000, yield_prob=args.yield_prob, speedup=False)
